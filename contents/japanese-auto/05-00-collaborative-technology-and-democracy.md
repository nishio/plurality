...
幸運なことに、中道的で実用的な複数の道が可能です。神の視点や地上の視点を排他的に取る必要はありません。代わりに、私たちはさまざまな社会集団の目標を追求するツールを構築することができます。視点ごとの制約と他の平行な発展方向から発信される並行する発展から学び、つながりを持つことに常に目を向けながら。私たちは社会的な豊かさの鍵となる要素をモデルに追加することで、市場機能の改革を目指すことができますが、より詳細な視点を追求する人々によって明らかにされた社会的な豊かさを考慮に入れないことによって、少なくとも一部は失敗する可能性があることを予想しながら、常にそうすることができます。私たちは人々が他者の内的な経験に共感する豊かな方法を構築することができますが、それらが熟議、規制、そしてよく構造化された市場と組み合わされない場合、それらのツールが悪用される可能性があることを理解しています。
