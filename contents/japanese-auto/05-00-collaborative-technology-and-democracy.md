...
この本は、多元主義を実践的に示し、説明するために作成されました。そのため、このセクションで説明する多くのツールを使用して作成されました。テキストは、オープンソースのコーダーがソフトウェアのバージョンを管理するために使用するGitプロトコルを使用して保存および更新されました。テキストは、クリエイティブ・コモンズ0のライセンス体制の下で自由に共有されており、ここに含まれるコンテンツに対するいかなる権利もコミュニティには保留されておらず、自由に再利用することができます。執筆時点では、世界中の多様な専門家がテキストに貢献し、出版前には桁違いの数の専門家が貢献することが予想されており、私たちのクリエイティブ・コラボレーションの章で説明する実践を体現しています。
...
本の出版プロセス中の財務ニーズをサポートするために、私たちは「市場」の章で説明するいくつかのツールを利用しました。部分的な共同所有と多元的な資金調達を含みます。私たちは、本のアイデアを世界中の観客とコミュニケーションし、探求するために、「没入型共有現実」の章からの技術を利用することを望んでいます。
...
人権オペレーティングシステムは基盤ですが、ほとんどの人にとってシステムのポイントは、それの上に構築されるものです。人権の基盤の上には、自由民主主義社会がオープンな社会、民主主義、福祉資本主義を運営しています。オペレーティングシステムの上には、顧客が生産性ツール、ゲーム、さまざまなインターネットベースのコミュニケーションメディアを実行します。この章では、前のセクションの多元社会プロトコルの基盤の上に構築できるコラボレーションテクノロジーを説明します。

本書のこのセクションを「民主主義」と題していますが、私たちが説明する予定の内容は、国家の統治システムとしての民主主義の一般的な説明をはるかに超えています。 代わりに、基本的な社会プロトコルの上にPluralityを構築するためには、アプリケーションが協力と協力を促進するさまざまな方法の全範囲を探求する必要があります。 しかし、これらのフレーズでも重要な点が見落とされています。それは、一緒に働くことが、個々に働く部分が別々に作成できるものよりも大きなものを作り出す力です。
...
主に測定の理由から、ガロールは人類の集団間の遺伝的多様性に焦点を当てています。今日、「多様性」という言葉は、特に現在の世界で特に文化的に優位なアメリカのような社会で歴史的に組織化された抑圧の次元を指定するために多くの文脈で使用されています。しかし、多様性にはさまざまな形があります。
...
異なるものを乗り越える難しさを超えることは、重要な危険も持っています。協力のために異なるものを結びつけることは、彼らの潜在能力を利用する一方で、将来の潜在能力を減少させることもあります。これは、紛争に対する保護として望ましいかもしれませんが、将来の多様性の生産能力にとって重要なコストです。グローバリゼーションが貿易による利益をもたらす一方で、料理の多様化などの利益をもたらす一方で、文化の均質化をもたらし、将来のそのような利益の機会を減少させる可能性があるというのは、古典的な例です。したがって、多元主義における重要な関心事は、多様性を横断した協力を活用するだけでなく、多様性を再生することです。多様性を活用する過程で、新しい社会的な違いの形成によっても補充されるようにすることです。


非常に自然な類推は、エントロピー系に対して行われます。 「低エントロピー」のシステムは、異なる部分から成ることが少ない、例えば異なる熱の領域や大気中に豊富に存在する酸素と反応していない複雑な炭化水素などです。 「エネルギー」を生み出すためのすべてのシステムは、この低エントロピー（「多様性」）を利用して仕事を生み出します。このようなシステムはまた、爆発（「紛争」）を通じた「制御されていない」熱の放出を回避する利点もあります。ただし、このような低エントロピーの使用は、その源を排除するため、常に新しい「パワー」の源を探し続けることになります。再生可能なエネルギー源に基づく「再生可能経済」に向けた取り組みは、少なくとも一時的にこの罠を回避するために、低エントロピーの源が常に補充されることを保証することを目指しています。同様に、私たちは既存の多様性を利用しながら新しい多様性を再生産する再生可能な多元主義を目指さなければなりません。
...
Pluralityの目標は、このトレードオフを緩和し、任意の多様性のレベルにおいてより大きな協力を可能にすること、または任意の協力の深さにおいてより大きな多様性を可能にすることです。実際、私たちは深さと広がりの完全なスペクトルが存在すると考えています。経済学者はしばしば「生産可能性フロンティア」（PPF）によって技術を説明し、緊張関係にある2つの望ましい事物の現在可能なトレードオフを示しています。同様に、図には協力の広がりと深さのPPFが示されており、フロンティア上のさまざまなポイントには、これらのポイントを具現化する現在の技術と開発中の技術の領域がラベル付けされています。本書のこの部分の残りの章では、これらのポイントを探求しています。Pluralityの目標は、このフロンティアを各ポイントで外側に押し出すことです。

<img src="https://raw.githubusercontent.com/pluralitybook/plurality/main/figs/PPF.png" width="100%" alt="多元主義の目標である、協力の幅と深さのトレードオフを表す生産可能性フロンティア上のポイントを外側に押し出すこと。">

政治学において、このトレードオフを示す一つの例があります。それは、民主主義政体における熟議の価値と投票の価値に関する議論です。高品質な熟議は、伝統的には小さなグループでのみ実現可能であり、そのためには代表的な政府選挙や抽選（ランダムに参加者を選ぶこと）など、より大きな人口を代表する小さなグループの選択プロセスが必要とされています。しかし、これによりより豊かな協力、参加者の視点のより完全な開示、そしてより良い最終的な集団的な選択がもたらされると信じられています。一方、投票は、より大きく多様な人口をより低いコストで関与させることができますが、各参加者が予め決められた選択肢の中から自分の意見を表明するという形式（通常は同意）で、自分の視点を薄く示すというコストがかかります。


しかし、「熟議的」民主主義と「選挙的」民主主義の支持者の間での議論はあるものの、これらはスペクトル上の2つのポイントに過ぎず、そのスペクトルの端点をさえ代表しているわけではありません。対面での熟議がどれほど豊かであっても、それはチームビルディング（例：軍隊）や長期的な親密な関係の構築と比べて、共有、つながり、共通の目的とアイデンティティの構築には遠く及びません。また、投票によって数億人が意思決定に参加できる一方で、それは非人間的なグローバル化した市場が日常的に行っている社会的な境界を越えることはありません。これらの形式はすべてトレードオフがあり、これまでにどのように航海してきたか、これらが時間とともに改善されてきた方法（例：ビデオ会議の登場）や将来的にどのように航海するかの多様性は、希望の源であり、共同開発がこれらのトレードオフを根本的に改善し、過去よりも広範な社会的な違いを持つ人々とのより豊かな協力を可能にすることができることを示しています。
...
経済学や数量的な分野などで特に一般的な視点の一つは、進歩を判断するために、グローバルな「客観的」または「社会的な福祉」の関数を明示するべきだと主張することです。もちろん、社会生活の無限の可能性の前では、そのような基準を明示しようとする試みは、未知の領域に墜落し、おそらく知り得ない領域に到達する運命に瀕しています。Pluralityを追求する際に、このような基準を野心的に適用するほど、それはより堅牢ではなくなります。なぜなら、より大きな違いを超えて他者とつながるほど、初期の良いビジョンの不備を実感する可能性が高くなるからです。世界の形について学ぶ前に、このような基準を明示することを強調することは、早期最適化につながり、すべての悪の根源とされています。

世界の豊かさと多様性を隠す最悪の悪は、おそらく新古典派経済学における市場の最適性に関する結論です。これは非常に単純化された仮定に依存しており、増加リターン、社会性、情報の不完全性、有限合理性などの問題を扱う社会資源管理システムを見つける試みをショートカットするためにしばしば使用されてきました。次の章で明らかになるように、これらの特徴に敏感な社会システムを構築する方法についてはほとんど知りませんし、それに対してさえほぼ最適な方法を知りません。これは、単純な善の概念を追い求める欲望が、多元主義の志向を追求するのに役立つだけでなく、それから私たちを誘惑する理由を示しています。私たちは、本当に求めているものではなく、説明しやすく簡単に達成できるものを最大化しようと誘惑されることがあります。
...
幸運なことに、中道的で実用的な多元的な道が可能です。神の視点や地上の視点に限定する必要はありません。代わりに、私たちはさまざまな社会集団の目標を追求するツールを構築することができます。視点ごとの制約や他の平行な発展方向から発信される並行する発展について学び、つながりを持つことを常に念頭に置いています。市場の機能を社会福祉に焦点を当てて改革することを目指すことができますが、より詳細な視点を追求する人々によって明らかにされた社会的豊かさの重要な要素をモデルに追加することに基づいて常に行うことができます。また、私たちの解決策がこれらを考慮に入れないことによって少なくとも一部が失敗することを予想しています。人々が他者の内的経験に共感する豊かな方法を構築することができますが、それらのツールが審議、規制、そしてよく構造化された市場と組み合わされない場合には悪用される可能性があることを理解しています。
...
本書のこの部分では、異なる分野間の協力のさまざまなアプローチを（完全には網羅していませんが）探求し、Pluralityのさらなる進展がこれらのアプローチを拡張し、発展させる方法について説明します。各章は、今日使用されている可能性のある最先端の技術の例を含むことで始まります。次に、その分野で一般的で新興しているアプローチの概要を説明します。その後、研究されている将来の発展の可能性と、これらのツールがPluralityに対して持つリスク（均質化など）やそれらを緩和するアプローチ、他の章で説明されているツールを利用することによるアプローチを強調します。私たちは、強調するさまざまなアプローチがPluralityの実質だけでなく、そのアプローチとの一貫性も引き出すことを望んでいます。多元的な補完的でネットワーク化された方向性だけが、多元的な未来の発展を支えることができます。
