...
&nbsp;&nbsp;&nbsp;&nbsp;高度なAIシステムにおける審議は望ましいものであり、人間に合わせたAIを理解するために関連しています。OpenAIの*Democratic Inputs*[^1]イニシアチブは、AIシステムの審議と遵守のための実験的な民主的プロセスを探求することを目指しています。初期の実験では、人間とAIのペア間の議論も披露されました[^3]。Anthropicもまた、*Constitutional AI (CAI)*による別の取り組みを探求しており、約1000人の個人がAIシステムのための憲法を起草しました。このような審議は、民主的なプロセスが民主的なAIにどのように影響を与えるかを明らかにするために行われました。Claudeも、国連の世界人権宣言などの憲法に触発されたCAIを利用しています。Polisは、Anthropic OpenAIとAI Alignment Assembliesが使用する主要な審議プラットフォームです。
...
さらに、民主的なプロセスにおける審議は、人間が実際により能力のあるLLM（スケーラブルな監視）を実際に調査する能力によっても制限されています。これは、監督が十分でないため、モデル評価者にとって独自の制約をもたらします。また、LLMは盲目的に指示に従うことが示されており、これはAIシステム内での民主的プロセスを損なう要因となる可能性があります[^2]。
...
[^1]: Tyna, Eloundou（OpenAI）et,al. AIへの民主的な入力、（2023）。https://openai.com/blog/democratic-inputs-to-ai

[^2]: David Glukhov、Ilia Shumailov、Yarin Gal、Nicolas Papernot、Vardan Papyan（2023）。LLM検閲：機械学習の課題またはコンピュータセキュリティの問題？https://arxiv.org/abs/2307.10719

[^3]: Geoffrey Irving、Paul Christiano、Dario Amodei「AIへの民主的な入力」、(2018)。https://openai.com/research/debate
