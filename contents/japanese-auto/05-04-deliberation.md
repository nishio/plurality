...
&nbsp;&nbsp;&nbsp;&nbsp;高度なAIシステムにおける審議は望ましいものであり、人間に合わせたAIを理解するために関連しています。OpenAIの*Democratic Inputs*[^DemocraticInputs]イニシアチブは、AIシステムの審議と遵守のための実験的な民主的プロセスを探求することを目指しています。初期の実験では、人間とAIのペア間の議論も行われました[^AIDebate]。Anthropicもまた、*Constitutional AI (CAI)*という取り組みを行っており、約1000人の個人がAIシステムのための憲法を起草しました。このような審議は、民主的なプロセスが民主的なAIにどのように影響を与えるかを明らかにするために行われました。Claudeもまた、国連の人権宣言などの憲法に触発されたCAIを利用しています。PolisはAnthropic OpenAIとAI Alignment Assembliesが使用する主要な審議プラットフォームです。
...
&nbsp;&nbsp;&nbsp;&nbsp;さらに、民主的なプロセスにおける審議は、人間が実際により能力のあるLLM（スケーラブルな監視）を実践的に調査する能力によっても制限されています。これは、監督が十分でないため、過度に強力なAIシステムによるモデル評価者にとって独自の制約をもたらします。LLMはまた、盲目的に指示に従うことが示されており、これはLLM検閲に関する問題を引き起こす可能性があります。これはAIシステム内で民主的プロセスを弱体化させる要因となります[^LLMCensorship]。
