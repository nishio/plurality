...
一方、Worldcoinのようにプライバシーが保護される場合、バイオメトリクスをアカウントの初期化にのみ使用することによって、システムはアカウントの盗難や販売の脆弱性にさらされます。なぜなら、ほとんどのサービスにアクセスするためには、単にユニークな人間であることを証明するだけでは不十分であり（例：特定の名前を持っていること、認識された政府によって発行されたID番号を持っていること、ある国の市民であること、および教育や雇用の資格などの他の属性など）、このプライバシーの極端な保護はシステムのほとんどの有用性を損ないます。さらに、このようなシステムはバイオメトリクスシステムの技術的な性能に大きな負担をかけます。もし将来的に人工知能システムと高度な印刷技術によって瞳孔が偽造される可能性がある場合、このようなシステムは極端な「単一障害点」にさらされる可能性があります。要するに、包括性と簡便性の重要な能力にもかかわらず、バイオメトリクスシステムは、多様性をサポートするために必要な豊かさとセキュリティでアイデンティティを確立し保護するには過度に簡略化されています。

非常に異なる場所から始まり、アイデンティティに関する別の一連の作業が同様の難しいトレードオフのセットに到達しました。 「分散型アイデンティティ」（DID）に関する作業は、上記で強調したデジタルアイデンティティに関する多くの懸念から成長しました：断片化、自然なデジタルインフラの不足、プライバシー、監視、企業の制御に関する問題。 キーファウンディングドキュメントは、マイクロソフトのアイデンティティアーキテクトであるキム・キャメロンの「アイデンティティの法則」であり、ユーザーの制御/同意の重要性、適切な当事者への最小限の開示、複数のユースケース、参加の多元主義、人間のユーザーとの統合、コンテキスト間の経験の一貫性を強調しています。 これらの原則に準拠するシステムを実現しようとする試みで、DIDの提唱者は、個人が「所有権」を持つプロトコルとオープンスタンダードを開発しました。これらは、ブロックチェーンなどの「公開」データリポジトリに根ざし、さまざまなエンティティがこれらのアカウントに対して資格情報を発行するための標準化された形式を作成します。
...
&nbsp;&nbsp;&nbsp;&nbsp;最近の多くのイニシアチブは、ワクチン接種状況の「SMARTヘルスカード」の作成や、欧州連合によるヨーロッパ全体での相互運用可能なデジタルアイデンティティの作成など、この戦場を航海しようとしています。これらのコンテキストでのアイデンティティの確立と保護の重要性を考えると、これらのイニシアチブの進展が遅いことは驚くことではありません。
...
[^1]: 参考文献 1) [社会保障庁](https://www.ssa.gov/policy/docs/ssb/v69n2/v69n2p55.html)による社会保障番号システムの歴史。2) Meiser, Kenneth Donaldson, UT Electronic Theses and Dissertationsによる[パンドラの箱を開ける：1937年から2018年までの社会保障番号](https://repositories.lib.utexas.edu/handle/2152/66022)。
[^2]: レコード、[コンピュータ、市民の権利](https://www.rand.org/content/dam/rand/pubs/papers/2008/P5077.pdf)を参照してください、1973年、ランド・コーポレーション。
[^3]: 1) [社会保障番号：民間企業は定期的にSSNを取得し使用しており、情報の開示は制限されています](https://epic.org/wp-content/uploads/privacy/ssn/gao-04-11.pdf) - GAO報告書、社会保障副委員長、社会保障委員会、下院。 2) [社会保障番号：連邦および州の法律はSSNの使用を制限していますが、まだギャップが存在します](https://www.gao.gov/assets/gao-05-1016t.pdf) - GAO証言、消費者事務局および政府運営委員会、ニューヨーク州議会の前で。
[^4]: ニュースリリース：[DHSは、社会保障番号の代替識別子に対する標準ベースのアプローチに193,000ドルを授与](https://www.dhs.gov/science-and-technology/news/2020/10/09/news-release-dhs-awards-alternative-identifier-social-security-number)
