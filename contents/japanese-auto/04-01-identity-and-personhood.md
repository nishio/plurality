...
非常に異なる場所から始まり、アイデンティティに関する別の一連の作業が同様の難しいトレードオフのセットに到達しました。 「分散型アイデンティティ」（DID）に関する作業は、上記で強調したデジタルアイデンティティに関する多くの懸念から成長しました：断片化、自然なデジタルインフラの不足、プライバシー、監視、企業の制御に関する問題。 キーファウンディングドキュメントは、マイクロソフトのアイデンティティ研究者であるキム・キャメロンの「アイデンティティの法則」であり、ユーザーの制御/同意の重要性、適切な当事者への最小限の開示、複数のユースケース、参加の多元主義、人間のユーザーとの統合、コンテキスト間の経験の一貫性を強調しています。 これらの原則に準拠するシステムを実現しようとする試みで、DIDの提唱者は、個人が「所有権」を持つプロトコルとオープンスタンダードを開発しました。これらのアカウントに対してブロックチェーンなどの「公共」データリポジトリに根ざし、さまざまなエンティティがこれらのアカウントに対して資格情報を発行するための標準化された形式を作成します。
...
最近のアイデンティティに関する多くの取り組みは、「スマートヘルスカード」の作成（ワクチン接種状況）や、欧州連合によるヨーロッパ全体での相互運用可能なデジタルアイデンティティの作成など、この戦場を航海しようとするために行われました。これらのコンテキストでのアイデンティティの確立と保護の重要性を考えると、これらの取り組みの進展が遅いことは驚くことではありません。
