...
この本では、この悲劇的な紛争を避けることができるということを示したいと考えています。適切に構想された技術と民主主義は、強力で自然な味方になることができるということを。しかし、この方向に向かう議論が多くの場所で目を剥くことを引き起こすのは偶然ではありません。この分裂の両側には、過去10年間にわたって不満と不信の溝が広がっており、簡単に解決することはできません。この紛争の両側の合法的な懸念と批判を完全に認識し、受け入れることによって、その根本原因を見るチャンスを得ることができるでしょう。したがって、私たちは寛大な精神でこれらの不満を引き出し、利用可能な証拠によって完璧にサポートされていない場合でも、広範な懸念を引き起こした批判を受け入れます。この紛争の最大の枠組みを調和させようとする試みは、民主的な技術の野心を高める機会を提供します。
...
技術に対する一般の人々や政策立案者の態度は、2010年代には明らかに否定的な方向に転じました。2000年代末から2010年代初頭にかけて、ソーシャルメディアやインターネットは開放性と参加の力として見られていましたが、2010年代後半には、上記の多くの問題の原因として広く非難され、一部の世論調査でも非難の対象となりました[^15]。この態度の変化は、おそらく最も明確にエリートの態度に反映されており、Cathy O'Neilの「Weapons of Math Destruction」やShoshanna Zuboffの「The Age of Surveillance Capitalism」などのベストセラーの技術書や、「The Social Dilemma」などの映画が公の議論を席巻し、左派のジェレミー・コービンや右派のジョシュ・ホーリーなどの政治指導者が技術産業に対してますます悲観的で攻撃的なトーンを取るようになったことで、明らかになりました。これらの懸念を表すために「Techlash」という言葉が注目されるようになりました（Google NGRAMSの言語を使用して図を示すことがあります）。これは、ソーシャルメディアを利用して著名人の文化的価値を攻撃または低下させることがしばしば行われる「キャンセルカルチャー」の台頭によって強化されています。
...
この情報技術に対する積極的な公共の関心の低下を示す最も明確な数量的指標は、国内総生産（GDP）の一部としての研究開発（R&D）への公共支出の減少です。特に情報技術においては、発展した民主主義国の大多数では、GDPに対する公共セクターの研究開発支出は過去数十年間にわたり減少してきました。一方で、企業のR&D支出は大幅に拡大し、中国本土政府の支出もGDPに対する割合で大幅に増加し、情報技術に焦点を当てています。[^16]。
...
オリジナルのインターネットはほとんどが公共部門や学術部門によって開発され、オープンスタンダードに基づいていましたが、Web 2.0や最近の「Web 3」や分散型ソーシャルテクノロジーに関する動きはほとんど公的な支援を受けていません。民主主義国家の政府はデジタル通貨、支払い、身分証明システムの可能性を探求するのに苦労しています。コンピューティングの最も基本的な進歩の多くは第二次世界大戦と冷戦中に民主主義政府から生まれましたが、現在の政府はコンピュータ科学を革新している「基礎モデル」の突破口にほとんど関与していません。実際、OpenAIの創設者であるサム・アルトマンとイーロン・マスクは、最初に公的資金を求め、何度も断られた後に私的な利益追求の源に頼ることになったと報告しています。OpenAIは、AIの可能性について一般の人々の想像力をますます捉えているGenerative Pretrained Transformer（GPT）モデルを開発しました[^18]。これは、中華人民共和国などの独裁政権とは対照的です。彼らは野心的な公共情報技術戦略を立て、それを大部分にわたって成功裏に展開しています[^19]。


公共部門が技術との関わりを持たないことは、研究開発にとどまらず、展開、採用、促進にまで及んでいます。デジタル接続性と教育の品質と利用可能性は、この点を測定するのに最も簡単な領域です。ここではデータはやや混在しています。多くの高機能な民主主義国家（スカンジナビア諸国など）は、高品質で高い利用可能なインターネットを持っています。しかし、特に最新の接続技術において、主導的な独裁政権は民主主義国家をはるかに上回る成果を上げていることが目立ちます。例えば、Speedtest.netによると、中国本土は世界の国々のインターネット速度で16位にランクされていますが、一人当たりの所得では72位です。サウジアラビアや他の湾岸諸国も同様に、自国の重要性に比べて大きな成果を上げています[^20]。最新世代のモバイル接続性である5Gの性能はより劇的です。さまざまな調査によると、中国とサウジアラビアは常に5Gの最もカバー範囲の広い国のトップ10に入っており、所得水準をはるかに上回っています。
...
最も野心的には、民主主義国家は、多くの専制政治国家が行ってきたように、技術が社会構造をどのように再構築するかの革新的な実験を支援することができます。しかし、ここでも、民主主義はしばしばそのような実験を促進するのではなく、逆に妨げるように思われます。中国は、深センなどの自動運転車を促進するための都市を建設し、規制を再構築し、政策、規制、投資のほぼすべての側面をカバーする詳細な国家技術戦略を策定しています[^21]。サウジアラビアは、砂漠に新しいスマートシティ「ネオム」を建設し、さまざまな緑の技術やスマートシティ技術を披露する予定ですが、GoogleのSidewalk Labsなどの最も控えめな地域プロジェクトでも、地元の反対によって圧倒されています。
...
同時に、独裁政権は最新のデジタルイノベーションを活用して、監視（善悪の両方）と社会的な統制を強化してきました。例えば、中国政府は広範にわたって顔認識を使用して人口の移動を監視し、デジタル元や他の監視されたデジタル決済（よりプライベートな代替手段を取り締まる）の採用を奨励し、さらに幅広い市民活動を追跡し、それらを単一で広範な影響力を持つ「評価」にまとめる包括的な「社会信用スコア」の開発に取り組んできました[^22]。数年間、ロシア政府は顔認識を使用して抗議活動に参加している人々を特定し、その後逮捕することで、政権や警察のリスクを低く抑えつつ、大規模な抗議者を排除することができるようになりました[^35]。これらの技術は強化され、ウクライナへの全面的な侵攻以来、徴兵の強制執行にも使用されています[^36]。
...
おそらく、最も印象的なイラストは、今日の国々間での技術の進歩の比較から得られます。かつては、先進的な思想家たちは、技術の力が社会の違いを一掃することを予測していましたが、今日では、大国や時には小国の技術システムが、公式に述べられたイデオロギーと同じくらいに、彼らの競合する社会システムを定義しています。中国本土の監視国家は、一つの技術的な未来のように見えますが、ロシアのハッキングネットワークは別の未来のように思えます。Web3駆動のコミュニティの成長する空間は、三番目の未来であり、私たちが焦点を当てている主要な西洋の資本主義国は四番目の未来であり、インド、エストニア、台湾の異質なデジタル民主主義は、私たちが以下で詳しく探求する別の未来です。収束するどころか、技術は可能な未来を増殖させているように思われます。
...
最近のベンチャーキャピタル業界の動向から始まり、過去10年間は人工知能と仮想通貨に関連する「Web3」技術へのベンチャーキャピタルの注力が劇的かつ圧倒的に増加しています。図Vは、NetBase Quidによって収集され、StanfordのCenter for Human-Centered Artificial Intelligenceの2022 AI Index Reportによってグラフ化されたAIへの民間投資のデータを示しており、2010年代に爆発的な成長を遂げ、民間技術投資を席巻してきました。図Wは、Pitchbookのデータに基づき、Galaxy Digital Researchによってグラフ化されたWeb3スペースの同様のデータを示しています（異なる期間と四半期で表示）。これらを総合的かつハイテク重視のベンチャーキャピタルと関連付け、一貫性のある単一のチャートに表示する必要があります。
...
しかし、これらの優先事項は比較的最近であり、「市場」の論理から浮かび上がったように見えますが、それらはより長期間にわたる集団的な選択の結果です。これらは民主主義国家の政府が行った投資に由来しています。ただし、これらのデータを掘り起こす必要があります。脚注にはいくつかのファクトイドがありますが、トピックエリア別の一貫した時系列の分解が必要です[^26]。

これらの投資は単に異なる選択肢であるだけでなく、非常に異なる方法で直前に行われたものです。私たちは、民間およびベンチャーキャピタルの投資に遡るデータを見つける必要があります。これらの投資は、過去数十年の典型的な技術に反映されています。人工知能は1980年代の大部分で来るべき革命として歓迎されました。Google nGramsによって追跡された英語の書籍でのこのフレーズの相対頻度を示すFIGURE HERE FROM GOOGLE NGRAMSに反映されています。しかし、1980年代の定義的な技術はまったく逆でした。個人の創造性を補完するコンピューティングを可能にしたパーソナルコンピュータでした。1990年代は、スティーブンソンのSF的な想像力によって追いかけられ、逃避的な仮想世界と原子化暗号化の可能性が広がりました。インターネットの結合組織が世界を席巻し、通信と協力の未曾有の時代を迎えました。2000年代の携帯電話、2010年代のソーシャルネットワーキング、2020年代のリモートワークの足場...これらはいずれも暗号超資本主義や人工超知能に焦点を当てていません。
