...
近幾十年來，科技界的主要趨勢是人工智慧和區塊鏈。這兩者分別賦予了中央集權的頂層控制和加速了分散化的極端對立和金融資本主義。這兩種結果都對民主多元主義的價值產生了腐蝕作用。因此，科技被廣泛認為是對民主的最大威脅之一，也是外部專制主義者和內部破壞民主的人的強大工具，這一點並不令人意外。
...
政治上，極化和極端主義政黨的影響力在許多發達民主國家中不斷上升。雖然基於互聯網的社交媒體景觀的作用是一個重要的學術辯論話題，但最近的調查表明，這些工具遠遠沒有實現加強社會和政治差異之間聯繫的承諾，並且很可能已經促成了自2000年以來極化的世俗上升，尤其是在美國[^5]。
...
科幻作品展示了人类思维所能想象的惊人未来范围。在许多情况下，这些想象是研究人员和企业家最终开发的许多技术的基础。其中一些对应于我们最近看到的技术发展方向。在他1992年的经典作品《雪崩》中，尼尔·斯蒂芬森想象了一个未来，大多数人都退缩到一个沉浸式的“元宇宙”中生活。在这个过程中，他们破坏了支持现实世界社区、政府等所必需的参与度，为黑手党和邪教领袖统治和发展大规模杀伤性武器创造了空间。这个未来与我们上面讨论的“反社会”威胁民主的技术元素密切相符，斯蒂芬森的其他作品进一步扩展了这些可能性，对技术发展产生了深远影响；例如，Meta的平台就是以斯蒂芬森的元宇宙命名的。类似的例子也适用于技术通过创建“超级智能”来集中权力的倾向。领先的例子包括艾萨克·阿西莫夫和伊恩·班克斯的小说、雷·库兹韦尔的预测未来主义以及《终结者》和《她》等电影。
...
然而，尽管这些优先事项相对较新，并且似乎是从“市场”的逻辑中产生的，但它们反映了一个更长期运行且集体直接的选择集。这些选择源于民主国家政府的投资。仍然需要挖掘这些数据；脚注中有一些事实，但我们需要有关主题领域的分解的一致时间序列。 [^26]
...
技術的發展道路如果不是預先確定的，而是可以通過集體選擇來顯著塑造，那麼我們應該如何思考我們作為一個社會在選擇可能的方向之間的靈活性？我們有多少選擇的空間，這些選擇又是什麼樣的？
