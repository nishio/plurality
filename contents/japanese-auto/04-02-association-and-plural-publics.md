...
個人だけでは、政治的、社会的、経済的な変革を実現することはありません。政党、市民団体、労働組合、企業などを通じた集団の努力が常に必要です。Pluralityにとって、これらのより形式的でない社会集団は、個人と同じくらい社会の基盤として基本的です。この意味で、結社は人間性の陰と陽であり、最も基本的な権利において暴君の災厄です。再びデ・トクヴィルの言葉を引用します。「エゴイズムほど（専制政治）に適した人間の欠陥はありません。暴君は、彼を愛さないことを除いて、彼の臣民が彼を愛さないことを許す余裕があります。」自由、自治、多様性を望むためには、意味のある代理権を持つ新しい結社の形成能力を促進し、保護することが唯一の方法です。
...
&nbsp;&nbsp;&nbsp;&nbsp;インターネットは、より広範な潜在的な関連性を可能にする一方で、コンテキストの*確立*と*保護*をより困難にしています。情報がより広範囲かつ速く広がるにつれて、話している相手や共有している情報を把握することが難しくなりました。さらに、グループを監視することが容易になったり、メンバーが意図しないコンテキスト外で情報を不適切に共有することが容易になったりしました。したがって、リックとテイラーの夢を実現し、デジタル世界が多元的な関連性が繁栄する場となるためには、情報のコンテキストを理解し、それをサポートし保護するデジタルシステムを構築することが必要です。

&nbsp;&nbsp;&nbsp;&nbsp;したがって、この章では、協会の情報要件に関する理論を概説します。その後、コンテキストの確立とその保護に役立つ既存の技術について議論します。そして、これらの技術を組み合わせて、プライバシーでも公開でもなく、むしろ「多元的な公衆」、外部の監視から保護された共通の理解の多くの協会の繁栄を実現する方法について説明します。なぜこれが他のデジタル権利の支援に非常に重要なのかも説明します。
...
&nbsp;&nbsp;&nbsp;&nbsp;もし文脈を確立することが主に公共性の強い社会的概念を作り出すことに関連しているのであれば、文脈を保護することは強く社会的なプライバシーの概念に関連しています。そして、公共性の技術と同様に、プライバシーの技術も、主に多元的な社会性をサポートするものよりも、より原子的な一元的な方向で開発されてきました。
...
この例は、「プライバシー」と「公開性」が自由な関連性のパターンを説明するにはあまりにも単純すぎる概念であることを示しています。どんな単純な記述子も、私たちが調査し続けるべき豊かさには及びませんが、より関連性のあるモデルは、私たちが「多元的な公衆」と呼んでいるものかもしれません。多元的な公衆は、内部の共通の信念を持つ多様なコミュニティが外部の世界から保護された状態で共存するための情報基準を作成することを目指しています。これを実現するには、システムの参加者が自分たちのコミュニケーションの文脈を簡単に確立し保護できる「文脈的な信頼性」を維持することが必要です。

&nbsp;&nbsp;&nbsp;&nbsp;幸いなことに、近年、プライバシーと公開性の両方のオープンスタンダード技術のリーダーの一部が、この問題に注目しています。ActivityPubの有名なLemmer Webber氏は、最近数年間、Spritelyというプロジェクトに取り組んでおり、多元的な公衆の精神に基づいて、自己統治型で強くつながったプライベートコミュニティを作成することを目指しています。これにより、個々のユーザーはオープンスタンダードでコミュニティの文脈を明確に識別し、ナビゲートし、分離することができます。Web3およびブロックチェーンコミュニティの研究者グループは、特にZKPを含むプライバシーテクノロジーとこれらを組み合わせることに取り組んでいます。
