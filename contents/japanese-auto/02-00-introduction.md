...
最近のベンチャーキャピタル業界の動向から始まり、過去10年間はハイテクノロジーセクターにおけるベンチャーキャピタルの注力が人工知能や仮想通貨関連の「Web3」技術に集中してきました。図Vは、NetBase Quidが収集した人工知能への民間投資のデータを、スタンフォード大学のCenter for Human-Centered Artificial Intelligenceの2022 AI Index Reportがグラフ化したもので、2010年代に爆発的な成長を遂げ、民間技術投資を席巻してきたことを示しています。図Wは、Pitchbookのデータに基づき、Galaxy Digital Researchがグラフ化したWeb3スペースの同様のデータ（異なる期間と四半期）を示しています。
