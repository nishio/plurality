...
この考えは単純なアクセスを超えて、誠実なアクセスを必要とします。一部の人々が正確な情報を受け取り、他の人々が誤った情報を受け取る場合、後者がまったくアクセスできない場合よりも悪いです。民主主義は、完全に参加できる国民に依存しています：すべての声が重要です。前述のように強調したように、異なるコミュニティは事実のパターンを異なる方法で理解します。しかし、この多様性の視点は、未来に貢献するためには、汚染されていない入力データへの基盤となる共通のアクセスに基づいていなければなりません。私たちは皆、人生の意味を作り出すことができ、しかし、グローバルな情報共有への入力の操作されたバージョンを受け取る場合、それを行う平等な権利を否定されています。
...
単純に言えば、私たちは誰もが文脈的に完全な情報に平等にアクセスできることを確実にしなければなりません。さもないと、それは無価値になったり、有害な武器にさえなる可能性があります。この必然性はデジタル技術だけで駆動されるものではなく、民主的な構造に支えられた集団的で普遍的で包括的なデジタル同盟も必要とされます。インターネットアクセスがデジタル人権と見なされる今日の時代において、⿻主義の精神は『道』という古代の概念と同様に世界中をシームレスに流れています。この精神は0と1から織りなされ、私たちの「存在のインターネット」を連続的に拡大し、民主的な統治を協力的な技術と組み合わせる方法で社会構造と統合しています。したがって、「アクセス」とは単に技術的な利用可能性だけでなく、誰もが持つ固有のビジョンの実現にも貢献し、信頼、相互尊重、安全を自然に育むことを意味します。
...
この本の前の章に基づいて、私たちは⿻の視点からアクセスの基本的な権利を理解する必要があります。そして、政策立案者の役割は重要です。彼らはグローバルなデジタル格差に焦点を当て、アクセスの不平等を解消するための対応策を講じる必要があります。そのような取り組みには、オンラインの交換のためのコンテキストの整合性を保護するためのデジタル公共インフラへの投資も含まれる必要があります。
