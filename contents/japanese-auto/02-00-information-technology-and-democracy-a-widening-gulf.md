...
社会的には、ソーシャルメディアが以前社会的に孤立していた人々（例：保守的な地域の性的少数者や宗教的少数者）にとって強力な新しいプラットフォームを提供してつながりを築くことができることを示す証拠が増えていますが、平均的にはこれらのツールが社会的な孤立や排除感を悪化させる要因となっているという証拠もあります[^OutInTheCountry]。
経済的には、インターネットやテレワークによって可能になった地理的、時間的、多雇用主の柔軟性が、発展途上国の多くの労働者や伝統的な労働市場に適合しない労働者にとって、多くの機会を拡大しています。しかし、これらの取り決めの潜在的な利益を労働者が共有できるようにする（労働組合や労働規制などの）適切な労働市場の制度の出現には、ほとんど対応していません。したがって、職場の不安定さを高め、多くの先進国で中間層の「空洞化」に寄与しています[^GhostWork]。
政治的には、極端な政党の影響力と極端化が、多くの先進民主主義国で着実に増加しています。 インターネットをベースとしたソーシャルメディアの役割は、重要な学術的議論の対象ですが、最近の調査では、これらのツールは社会的および政治的な違いを超えた絆を強化するという約束を果たすことができず、特に2000年以降の極端化の世俗的な上昇に寄与している可能性があることを示唆しています[^PolarizationResearch]。
- 法的には、過去数十年にわたる金融イノベーションの拡大は、限られた測定可能な消費者の利益（リスクの低減、資本配分、または信用へのアクセス）をもたらしてきましたが、金融システムの多くでリスクを増大させ、金融商品を増殖させる一方で、これらの害を緩和することを意図した既存の規制体制に対する挑戦や回避をもたらしています[^FinancialInnovation]。2008年の金融危機に至るまでの住宅金融に関するイノベーションは、最も影響力のある例の一部でしたが、もっとも極端な（もっとも制約された）ケースは、最近のデジタル「暗号」資産や通貨に関する活動です。既存の規制体制との不一致から、これらは広範な投機、ギャンブル、詐欺、規制および税務逃れ、およびその他の反社会的な活動の機会を提供しています[^CryptoChallenges]。
存在的には、社会の意味づけと集団行動能力の分断が増大していることが懸念されており、大規模破壊技術の洗練度が高まる中で危険であるとされています。その影響は環境破壊（例：気候変動、生物多様性の喪失、海洋酸性化）からより直接的な兵器（例：不適切な人工知能と生物兵器）による潜在的なアポカリプス的な混乱まで及びます[^TechnologySocietyImpact]。しかし、技術が民主社会の結束を侵食する一方で、政府の支配を強化し、権力を一部の私的な行為者の手に集中させることで、民主主義を脅かすとも見なされるようになっています。
情報技術の最も一貫した影響は、情報の利用可能性を拡大し、情報の拡散を加速させることです。これにより、私生活の範囲が劇的に侵食され、ますます多くの情報が公に利用可能になりました。このような透明性は原則としてさまざまな社会的影響を持つ可能性がありますが、そのような情報の処理と理解の力は、情報への特権的なアクセスと大規模な統計モデル（つまり、「AI」）への投資資本を持つ企業や企業の手に集中しています。さらに、これらのモデルはより多くのデータと資本にアクセスすることで大幅に改善されるため、中央の主要な行為者が両方の非常に大きなプールにアクセスできる社会は、知覚される「AIレース」で先行する傾向にあり、情報力の集中を許可するためにすべての社会に圧力をかけています[^SurveillanceCapitalism]。これらの力が結集することで、前例のない監視システムと情報フローの中央集権的な制御が標準化されました。
法的には、AIの最近の進歩の速さと変革力は、多くの民主社会の基本的な権利を圧倒し、類似の社会的背景を持つ制限されたグループのエンジニアの手に重要な選択肢を残しています。知的財産法や他の創造活動の保護は、大規模なAIモデルがコンテンツを「リミックスして置き換える」能力によってほとんど無効化されています。プライバシー制度は情報の爆発的な拡散に追いつくことができず、差別法はブラックボックスAIシステムの潜在的なバイアスによって引き起こされる問題に対処するのに適していません。一方、これらの問題に対処できる可能性のあるエンジニアは、通常、利益を追求する企業や防衛部門で働き、非常に特定の教育的および人口統計的背景（通常は白人またはアジア人、男性、無神論者、高学歴など）を持っています。これは、広範な社会の意思を代表しようとする民主的な法制度の核心的な原則に挑戦しています[^AIChallenges]。
経済的には、AIと関連する広範な情報技術の傾向が、特に教育水準の低い労働者を補完するのではなく、置き換えることによって、過去数十年間における資本収益の割合の急激な上昇の中心的要因であるという証拠が増えています。その結果、発展途上国における所得格差の拡大の主要な原因となっています[^AIandInequality]。世界中での市場力、マークアップ、産業集中の上昇は、労働力の割合の低下に伴って特に顕著であり、情報技術を最も積極的に導入している国や産業部門で特に顕著です[^MarketPower]。
上記の力は、政治的および地政学的に、民主主義国に対する独裁政権や政治運動を強化しています。大規模な監視、AI、およびその他の大規模データ処理ツールの作成により、政府が直接的に検閲と社会的な統制を維持することが容易になりました。間接的には、経済力と社会的統制のレバレッジを（しばしば企業の）少数のチョークポイントに集中させることにより、資本収入と市場力の増加、およびエンジニアの少数のグループの権威の増大により、独裁政権が経済と社会の「指導的地位」を容易に操作または奪取することが容易になりました[^AuthoritarianTech]。
