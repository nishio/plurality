...
&nbsp;&nbsp;&nbsp;&nbsp;今日の世界は商業的な性格が非常に強いためか、このセクションで議論するプロトコルのいずれも、支払いや商取引を容易にする新しいアプローチほどメディアや政策の注目を浴びていません。暗号通貨は過去10年間の主要な技術の一つでした。しかし、それに次いで少し注目され、より広く採用されているのは、インドやブラジル、シンガポールなどの場所で政府の身分証明書を使用した即時支払い技術、中央銀行デジタル通貨（CBDC）、中国で使用されている規制された相互運用可能なデジタル支払いシステムなど、さまざまな政府や公共の支払いイノベーションです。これらのシステムは普及率や相互運用性にはまだ程遠いですが、新世代の支払いシステムは世界中の多くの人々の生活にますます浸透しており、デジタル空間での支払いが過去に現金が提供していたものと同じくらい簡単またはより簡単になっています。
...
&nbsp;&nbsp;&nbsp;&nbsp;この実現は興味深く、オンライン決済の最初の主要手段の一つであるPayPalとの類似点が見られます。PayPalは当初、創業者のマックス・レフチン、ルーク・ノセック、ピーター・ティールによって新しいデジタル通貨として構想されましたが、すぐにインターネット対応の決済プロセッサに移行しました。Bitcoinの早期の成長に続いて、他の多くの民間の、迅速で低コストなプロセッサが市場に参入しました。これには、ビジネスをターゲットにしたSquareやStripe、個人間のカジュアルな取引をターゲットにしたVenmoなどが含まれます。これらはすべて、Bitcoinの発売直後の数年間にアメリカで設立されました。さらに印象的なのは、中国本土でのWeChat Payを通じた非常に低コストなソーシャルペイメントの急速な普及と、アジアの他の地域でのLine Payを通じた普及です。これらには、Apple、Amazon、Googleなどの最大のテクノロジープラットフォームによって支援された類似のサービスの範囲が続きました。
 
これらのサービスをより低コストで、特にこれらの米国および中国本土に拠点を置くサービスが不十分に提供されている市場で包括的に提供することを目指して、いくつかの主要な途上国政府は公的に支援された即時支払いサービスを作成しました。これには、2014年のシンガポールのFASTシステム、2020年のブラジルのPixシステム、2022年のインドの統一支払いインターフェースが含まれます。さらに、2023年には米国もFedNowを導入しました。国際間の相互運用にはまだ重要な障壁がありますが、即時支払いをオンラインおよび対面でデジタルチャネルを通じて行うための即時のギャップが埋まったという点で、ますます合意が形成されています。これにより、これらのシステムの多くが独自のものになったことが、この領域の評価の崩壊の少なくとも部分的な説明となる可能性があります。
