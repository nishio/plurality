...
* 中國國民運動，其創始人孫中山從喬治·梅奇（George）那裡獲得了他的“三民主義”，就像列寧和毛澤東從馬克思那裡獲得靈感一樣，這導致了今天台灣對喬治的持續尊崇；
...
&nbsp;&nbsp;&nbsp;&nbsp;因此，國家身份系統所追求的個體，實際上是從他們的成長、繁殖和交叉中浮現出來的，而不是從社區的束縛中解放出來的。正如一個真正公正和高效的財產制度應該承認並考慮到這種網絡相互依賴，真正賦予和支持現代生活的身份系統需要反映其交叉、網絡化的結構。
...
彼の1927年の著書『公共とその問題』で、ジョン・デューイはこれらの「新興の公衆」と呼ばれるものの政治的な意味とダイナミクスを考察しました[^4]。デューイはデューイ十進分類法の発明者であり、「進歩的教育」の父としても知られるアメリカの哲学者であり、民主主義の哲学者でもありました。彼は彼の時代の進歩的政治の「民主主義」派を率い、左派の技術主義者ウォルター・リップマンとの有名な一連の討論にも参加しました。リップマンの1922年の著書『公共の意見』はデューイにとって「現在の概念に基づく民主主義への最も効果的な告発」と考えられていました。討論の中で、デューイは民主主義を救済し、同時にリップマンの既存の制度に対する批判を完全に受け入れ、ますます複雑でダイナミックな世界に適していないと考えました。
...
&nbsp;&nbsp;&nbsp;&nbsp;杜威尊崇民主作为他职业生涯中最基本的原则；几乎每一段都离不开他对民主的回顾。他坚信民主行动可以解决市场的缺陷。然而，他像对资本主义一样严重地看到了现有“民主”制度的局限性。问题在于，根据杜威的观点，现有的民主制度在应对技术带来的新挑战时并不真正民主。
...
&nbsp;&nbsp;&nbsp;&nbsp;所有这些批评和思考方向都是有启发性的，但似乎没有一个提供明确的行动路径和进一步的科学发展。将对社会组织的复数、网络化本质的理解转化为科学引擎，能否产生新形式的社会组织？这个假设是诺伯特·维纳从中孕育出现代“控制论”领域的种子，从而衍生出所有用于描述数字技术的“网络”的用途，许多人认为，后来将类似工作命名为“计算机科学”。维纳将控制论定义为“动物和机器等复杂系统中的控制和通信科学”，但最广泛接受的意义可能是“网络内部的沟通和治理的科学”。这个词是从希腊的一个比喻中得来的，比喻是一艘由众多桨手的输入指导的船。
...
千禧年之交的繁榮和衰退狂熱中，科技界很少有人關注到長期被遺忘的泰德·納爾遜所帶來的威脅。納爾遜一直在尋求理想的網絡和通信系統，並不斷警告新興WWW設計的不安全性、剝削性結構和不人道的特點。如果沒有安全的身份系統（Xanadu原則1和3），無政府狀態和國家和企業的土地搶奪將是不可避免的。如果沒有嵌入商業協議（Xanadu原則9和15），在線工作將變得貶值，或者金融系統將被壟斷控制。如果沒有更好的安全信息共享和控制結構（Xanadu原則8和16），監控和信息封閉將無所不在。無論它看起來多麼成功，WWW-Internet注定會以悲劇收場。
...
&nbsp;&nbsp;&nbsp;&nbsp;公共和社會部門投資的角色下降，使得像Lick和Nelson這樣的領導者所看到的互聯網的核心功能/層次（例如身份、隱私/安全、資產共享、商業）缺失。雖然在互聯網上運行的應用程序和WWW上還有很大的進步，但在Lick撰寫時，協議的基本投資大部分已經結束。公共和社會部門在定義和創新網絡的角色很快就被超越了。
...
尽管我们在介绍中强调，技术的主导推动力发展的方向与民主相冲突，但这一新一代的领导者形成了一个对比鲜明的模式，一个分散但明显可辨的光明节点，共同带来希望，通过重新共同行动，多元化有朝一日可以激发技术的巨大潜力。对于普通互联网用户来说，也许最生动的例子就是维基百科。
...
&nbsp;&nbsp;&nbsp;&nbsp;毕竟，尽管全球分布的激励性例子是如此令人鼓舞，但我们大多数人仍然将社会的例子视为国家的范畴，并因此将国家视为典范模型。虽然世界上许多社会都展示了多元化的理想并采用了多元化的工具，但爱沙尼亚和台湾两个典范尤为突出。爱沙尼亚和台湾都拥有受到多元政治思想影响的政府，特别是亨利·乔治的思想，并面临来自侵略性威权邻国的严峻和持久的威胁。借鉴这一历史并受到这些挑战的推动，它们开创了将多元技术应用于塑造民主和公共部门的先河。
