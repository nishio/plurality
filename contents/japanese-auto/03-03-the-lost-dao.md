...
&nbsp;&nbsp;&nbsp;&nbsp;導入部で強調したように、技術の主流は民主主義と衝突する方向に発展してきましたが、新世代のリーダーたちは対照的なパターンを形成しており、明確に識別可能な光の散在したノードが共に希望を与えています。再び共通の行動を起こすことで、多元主義がいつか技術全体を活性化させる可能性があります。一般のインターネットユーザーにとって最も鮮明な例はWikipediaかもしれません。
...
「Wiki」という概念は、Wikipediaがその名前を得る源流であり、協力的な知識創造と共有における画期的な革新を表しています。"Wiki"という用語は、ハワイ語で「速い」という意味であり、最初のウィキソフトウェアであるWikiWikiWebを作成したWard Cunninghamによって1995年に造られました。カニンガムのビジョンは、相互にリンクされたウェブページの簡単で迅速な作成と編集を促進し、協力的な環境を作ることでした。ウィキの概念の本質は、Ward CunninghamとBo Leufによって2001年の書籍「The Wiki Way: Quick Collaboration on the Web」で詳細に説明されており、包括性と継続的な協力を強調しています。ウィキは、専門家だけでなくすべてのユーザーに、標準のウェブブラウザを使用してページの編集や新規作成を招待しています。ユーザーは直感的なリンク作成を通じてページ間のつながりを作ることが奨励され、典型的な訪問者を創造と協力の継続的なプロセスに巻き込み、動的で進化する「ウェブ」の景観を育んでいます。コンテンツ作成の民主化は、多元性と積極的な参加の概念を具現化し、Wikipediaなどのプラットフォームで見られる多様な知識のリポジトリとコミュニティ参加に大きく貢献しています。

Wikipediaを超えて、協力ソフトウェアまたはグループウェアの進化は、集団作業や知識共有に革新をもたらしました。グループウェアは、場所に関係なく人々が協力して作業するのを支援するために設計されたさまざまなアプリケーションを包括しています。協力ソフトウェアの概念は、1951年のダグラス・エンゲルバートの初期のビジョンにさかのぼり、コンピューティングを通じて集団作業を向上させることを目指しています。最初の実用的な協力コンピューティングのプロトタイプは、エンゲルバートの研究チーム内で1960年代半ばに現れ、1968年の画期的な公開デモンストレーションにつながりました。このデモは、「すべてのデモの母」として有名です。1978年に「グループウェア」という用語がピーターとトルーディ・ジョンソン＝レンツによって作られ、1990年代にはLotus Notesなどの初期の商用製品が登場し、リモートグループ協力を可能にしました。これらのソフトウェアは、さまざまな組織的な文脈で多様な協力的なタスクをサポートすることで、グループが共通の目標を達成するのを支援するよう設計されています。

コラボレーティブなリアルタイムエディタの概念は、ダグラス・エンゲルバードによって示され、2011年にWebSocketプロトコルの標準化によりWebシステムで利用可能となりました。コラボレーティブなリアルタイムエディタは複数のユーザーが同時にドキュメントを編集できるようにします。これは、オンラインで文書や他者とのやり取りをどのように進化させるかを示すものです。2005年にWritelyから発展したGoogle Docsは、コラボレーティブなリアルタイム編集の概念を広めました。コラボレーティブなリアルタイムのMarkdownエディタであるHackMDは、台湾のg0vコミュニティ内で使用され、会議の議事録などの文書を共同で編集し公開するために利用されています。現在、数百の文書が利用可能です。リアルタイムエディタとウィキシステムの組み合わせであるScrapboxは、多元主義の日本のフォーラムで利用され、共有された理解の基盤を作るために活用されています。フォーラムの訪問者は、ドラフトを読み、リアルタイムで質問や説明、関連トピックへのリンクを追加することができます。このインタラクティブな環境は、参加者が質問を書き、口頭で議論に参加したり、その議論の議事録を取るなどの活動をサポートしています。キーワードの名前を変更しながらネットワーク構造を維持する機能は、用語のバリエーションを統一し、適切な翻訳を見つけるプロセスを支援します。より多くの人々が読み進めるにつれて、知識のネットワークが育まれ、後続の読者の理解を支援します。

これらの文書は、多くの参加者によって共同で編集されており、この倫理の典型的な例が一般的に見られます。しかし、この倫理はオンライン世界自体の根底に浸透しています。オープンソースソフトウェア（OSS）は、ウィキペディアのように、参加型でネットワーク化された、国際的な自己統治の倫理を体現しています。Linuxオペレーティングシステムによって大きく代表されるOSSは、多くの公共クラウドインフラストラクチャの基盤をなし、GitHubのようなプラットフォームを通じて多くの人々とつながっています。全スマートフォンの70％以上を動かすAndroid OSも、Googleが主に維持しているにもかかわらず、OSSプロジェクトです。そして、"ピア生産"やフリーソフトウェアの成功と影響は、長い間学術的な関心の対象となってきました。たとえば、Yochai Benklerの2002年の著作は、プログラマーがなぜ市場ベース、企業ベース、ハイブリッドモデルによって生成される通常のシグナルに従わずにフリーソフトウェアプロジェクトに参加するのかという"パズル"に注目を集める点で非常に影響力があります。[^benkler_linux]
...
コミュニケーションネットワークへの公共投資からの転換に対する別の対照的な反応は、上記で触れたJaron Lanierの仕事によって示されました。彼は、EngelbartやNelsonのような文化デザイナーの道をたどり、CerfやCrockerのような組織のリーダーとは異なりました。AIの先駆者Marvin Minskyの学生であり批評家である彼は、AIと同じ野心を持った技術プログラムを開発しようとしましたが、人間の経験とコミュニケーションを中心に据えました。既存のコミュニケーション形態を、言葉や画像のように耳や目で処理できるシンボルによって制約されていると見なし、触覚や内部感覚（固有感覚）のような体験をより深く共有し、共感することを目指しました。1980年代における彼の研究と起業を通じて、これは「バーチャルリアリティ」という分野に発展しました。これは、有線グローブからAppleのVision Proのリリースまで、ユーザーとのインタラクションにおける革新の源泉となってきました。
