This repository is forked from pluralitybook/plurality for Japanese translation. You can discuss about the book in Japanese on the forum [plurality-japanese](https://scrapbox.io/plurality-japanese/)

(For Japanese) このリポジトリは pluralitybook/plurality の和訳のためのフォークです。この本について、フォーラム[plurality-japanese](https://scrapbox.io/plurality-japanese/)で日本語で議論することができます。
